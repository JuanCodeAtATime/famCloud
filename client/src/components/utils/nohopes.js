...
function FileUpload(props) {
    ...
    const onDrop = (files) => {
        ...
        formData.append("galleryImages", files[0])
        //save the Image we chose inside the Node Server 
        Axios.post('/api/photo/uploadImage', formData, {
            headers: {
            ...
            .then(response => {
                if (response.data.success) {
                    ...
                    console.log("this is the response.data from the file upload" + response.data)
